...
def main(cmd_args=any):
    if(cmd_args.list==False):
        ...
        if(cmd_args.dir==""):
            result_log = PRJ_ROOT + "/work/regression/report/" +test_file+"_"  + date_time + "/test_result.log"
        else:
            result_log = PRJ_ROOT + "/work/" + cmd_args.dir + "/report/" +test_file+"_"  + date_time + "/test_result.log"
        ...
        list_f = open(PRJ_ROOT+"/flow_record.txt","r")
        ...
        for list in list_content:
            if(list!=""):
                ...
                if(days_dif<30):
                    ...
                    status_dict[date]["dir"] = dir.replace(PRJ_ROOT+"/work/","")
        ...
        new_list_f = open(PRJ_ROOT+"/flow_record.txt","w")
