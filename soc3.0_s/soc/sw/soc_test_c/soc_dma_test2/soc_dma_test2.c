...
int main(int argc, char **argv) {
  ...
  *(qspi_base+3)=0xF4;
  ...
  write(0x3000000c,0x00010100);   //xfer start + xfer_size

  write(0x30000020,0x00063000);   //target
  write(0x30000024,0x00064000);   //src
  write(0x3000002c,0x00010100);   //xfer start + xfer_size
