...
// config registers
  ...
  input      [ 3:0] ahb_byte,
  output reg [31:0] dma_tadd,
  output reg [31:0] dma_sadd,
  output reg [31:0] dma_buff,
  output reg [31:0] dma_xfer,
  output reg [31:0] taddr,
...
begin
    ...
    begin
        if (abort_sel)
            abort <= 1'b1;
        else if ((taddr_sel | saddr_sel | trans_sel | abort_sel) &
                 xfer_start)
            abort <= 1'b1;
