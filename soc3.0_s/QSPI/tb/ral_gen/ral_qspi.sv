...
class ral_block_qspi extends uvm_reg_block;
   ...
   virtual function void build();
      ...
      this.default_map.add_reg(this.SPI_STATUS, `UVM_REG_ADDR_WIDTH'h1, "RO", 0);
      ...
      this.default_map.add_reg(this.SPI_CLKDIV, `UVM_REG_ADDR_WIDTH'h2, "RW", 0);
      ...
      this.SPI_CMD.build();
      this.default_map.add_reg(this.SPI_CMD, `UVM_REG_ADDR_WIDTH'h3, "RW", 0);
      ...
      this.SPI_ADR.build();
      this.default_map.add_reg(this.SPI_ADR, `UVM_REG_ADDR_WIDTH'h4, "RW", 0);
      ...
      this.SPI_LEN.build();
      this.default_map.add_reg(this.SPI_LEN, `UVM_REG_ADDR_WIDTH'h5, "RW", 0);
      ...
      this.SPI_DUM.build();
      this.default_map.add_reg(this.SPI_DUM, `UVM_REG_ADDR_WIDTH'h6, "RW", 0);
      ...
      this.default_map.add_reg(this.SPI_TXFIFO, `UVM_REG_ADDR_WIDTH'h7, "RW", 0);
      ...
      this.default_map.add_reg(this.SPI_RXFIFO, `UVM_REG_ADDR_WIDTH'h8, "RW", 0);
      ...
      this.default_map.add_reg(this.SPI_INTCFG, `UVM_REG_ADDR_WIDTH'h9, "RW", 0);
      ...
      this.default_map.add_reg(this.SPI_INTSTA, `UVM_REG_ADDR_WIDTH'hA, "RW", 0);
