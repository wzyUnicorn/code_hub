...
`define REG_CTRL   4'b0000 // BASEREG + 0x00
`define REG_STATUS 4'b0001 // BASEREG + 0x04
`define REG_CLKDIV 4'b0010 // BASEREG + 0x08
`define REG_SPICMD 4'b0011 // BASEREG + 0x0C
`define REG_SPIADR 4'b0100 // BASEREG + 0x10
`define REG_SPILEN 4'b0101 // BASEREG + 0x14
`define REG_SPIDUM 4'b0110 // BASEREG + 0x18
`define REG_TXFIFO 4'b0111 // BASEREG + 0x1C
