...
//**************************************************************
`celldefine
module RCMCU_PLVDDHL (VDDHI, VSSHI);
    inout VDDHI;
    supply1 VDDHI;
...
module RCMCU_PLOSD (CLK, OSCOUT, EI, EO, OSCIN);
	output CLK;
	output OSCOUT;
	input  EI;
	input  EO;
