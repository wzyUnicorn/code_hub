...
def create_testcase(
    ...
    testcase_file.write('''TESTCASE:TEST_NAME=%s::COMPILE_FILE=%s::COMPILE_NAME=%s::SIM_OPTION=%s::PRE_SIM_CMD=%s::TAG=%s::UVM_EN=%s::\n'''%(test_name,compile_file,compile_name,sim_option,pre_sim_cmd,tag,uvm_en))
    testcase_file.close()
