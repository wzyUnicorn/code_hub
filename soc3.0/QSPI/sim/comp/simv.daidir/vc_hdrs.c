...
void __vcs_export_dpi_dummy_references__()
{
    ...
    void (*fp11)(void) = (void (*)(void)) pli_dhier_begin_event;
    fp11 = fp11;
    extern void pli_trans_add_class_name_attr(void);
    void (*fp12)(void) = (void (*)(void)) pli_trans_add_class_name_attr;
    fp12 = fp12;
    extern void pli_trans_add_vif_attr(void);
    void (*fp13)(void) = (void (*)(void)) pli_trans_add_vif_attr;
    fp13 = fp13;
    extern void pli_dhier_set_label(void);
    void (*fp14)(void) = (void (*)(void)) pli_dhier_set_label;
    fp14 = fp14;
    extern void pli_dhier_add_attribute(void);
    void (*fp15)(void) = (void (*)(void)) pli_dhier_add_attribute;
    fp15 = fp15;
    extern void pli_dhier_add_attribute_int(void);
    void (*fp16)(void) = (void (*)(void)) pli_dhier_add_attribute_int;
    fp16 = fp16;
    extern void pli_dhier_end_event(void);
    void (*fp17)(void) = (void (*)(void)) pli_dhier_end_event;
    fp17 = fp17;
}
