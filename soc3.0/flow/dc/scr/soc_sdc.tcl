...
set pclk_ports [list \
    ...
    pad[11] pad[13] pad[15] pad[16] \
    pad[17] pad[18] pad[19] pad[20] \
]

set pclk_inputs  [get_ports $pclk_ports]
set pclk_outputs [get_ports $pclk_ports]

set_input_delay -max [expr $CYCLE100M * 0.45] -clock [get_clocks pclk] $pclk_inputs -add_delay
...
set_drive 0 [get_ports [list pad[21] pad[23] pad[12] ]]
