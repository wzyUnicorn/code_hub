...
# DVE full session
# Saved on Tue Dec 19 19:04:12 2023
# Designs open: 1
...
set HSPane.1 [gui_create_window -type HSPane -parent ${TopLevel.1} -dock_state left -dock_on_new_line true -dock_extent 316]
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 315} {height 554} {dock_state left} {dock_on_new_line true} {child_hier_colhier 174} {child_hier_coltype 134} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 553
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 324} {height 554} {dock_state left} {dock_on_new_line true} {child_data_colvariable 152} {child_data_colvalue 112} {child_data_coltype 53} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1913} {height 177} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_2 tb1
gui_sg_create "$_session_group_2"
set tb1 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb1.ch2_valid tb1.ch0_valid tb1.ch1_data tb1.ch1_ready tb1.rstn tb1.ch1_margin tb1.ch1_valid tb1.ch0_data tb1.ch0_margin tb1.mcdt_data tb1.clk tb1.ch2_ready tb1.ch0_ready tb1.ch2_data tb1.mcdt_id tb1.mcdt_val tb1.ch2_margin }

set _session_group_3 Group1
gui_sg_create "$_session_group_3"
set Group1 "$_session_group_3"

gui_sg_addsignal -group "$_session_group_3" { tb1.ch2_valid tb1.ch0_valid tb1.ch1_data tb1.ch1_ready tb1.ch1_margin tb1.rstn tb1.ch0_data tb1.ch1_valid tb1.ch0_margin tb1.mcdt_data tb1.clk tb1.ch2_ready tb1.ch0_ready tb1.mcdt_val tb1.mcdt_id tb1.ch2_data tb1.ch2_margin }
...
catch { gui_list_select -id ${Data.1} {tb1.ch2_valid tb1.ch0_valid tb1.ch1_data tb1.ch1_ready tb1.ch1_margin tb1.rstn tb1.ch0_data tb1.ch1_valid tb1.ch0_margin tb1.mcdt_data tb1.clk tb1.ch2_ready tb1.ch0_ready tb1.mcdt_val tb1.mcdt_id tb1.ch2_data tb1.ch2_margin }}
