...
# DVE full session
# Saved on Tue Dec 19 18:50:46 2023
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 316} {height 553} {dock_state left} {dock_on_new_line true} {child_hier_colhier 174} {child_hier_coltype 134} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 325} {height 553} {dock_state left} {dock_on_new_line true} {child_data_colvariable 152} {child_data_colvalue 112} {child_data_coltype 53} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1913} {height 178} {dock_state bottom} {dock_on_new_line true}}
...
gui_set_env SIMSETUP::SIMARGS {{-a run.log +ntb_random_seed=1}}
gui_set_env SIMSETUP::SIMEXE {tb1.simv}
gui_set_env SIMSETUP::ALLOW_POLL {0}
if { ![gui_is_db_opened -db {/home/ICer/luke_verify/lab0/tb1.simv}] } {
gui_sim_run Ucli -exe tb1.simv -args { -a run.log +ntb_random_seed=1 -ucligui} -dir /home/ICer/luke_verify/lab0 -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_1" { tb1.ch0_ready tb1.ch0_margin tb1.ch1_ready tb1.ch1_margin tb1.ch2_ready tb1.ch2_margin tb1.mcdt_data tb1.mcdt_val tb1.mcdt_id tb1.clk tb1.rstn tb1.ch0_data tb1.ch0_valid tb1.ch1_data tb1.ch1_valid tb1.ch2_data tb1.ch2_valid }

set _session_group_2 Group2
gui_sg_create "$_session_group_2"
set Group2 "$_session_group_2"

gui_sg_addsignal -group "$_session_group_2" { tb1.ch0_ready tb1.ch0_margin tb1.ch1_ready tb1.ch1_margin tb1.ch2_ready tb1.ch2_margin tb1.mcdt_data tb1.mcdt_val tb1.mcdt_id tb1.clk tb1.rstn tb1.ch0_data tb1.ch0_valid tb1.ch1_data tb1.ch1_valid tb1.ch2_data tb1.ch2_valid }
